...
using var websocketClient = new WebsocketClient(new Uri("wss://localhost:7215/thermostat/1234/socket"));

await websocketClient.Start();

websocketClient.MessageReceived.Subscribe(msg =>
{
    var command = JsonSerializer.Deserialize<ThermostatCommand>(msg!);
